      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        >
          <div className="flex flex-col sm:flex-row sm:items-center space-y-3 sm:space-y-0 sm:space-x-2">
            <motion.div 
              className="w-full sm:w-52 h-5 sm:h-6 bg-gray-200 dark:bg-gray-700 rounded animate-pulse flex-shrink-0" 
              aria-hidden="true"
              variants={itemVariants}
            />
            <motion.div 
              className="w-full sm:w-48 h-9 sm:h-10 bg-gray-200 dark:bg-gray-700 rounded animate-pulse flex-shrink-0" 
              aria-hidden="true"
              variants={itemVariants}
            />
          </div>
        ...
        >
          ...
          >
            ...
            <div className="w-8 h-6 sm:w-10 sm:h-8 bg-gray-200 dark:bg-gray-700 rounded animate-pulse mt-1" />
          </motion.div>
          <motion.div 
            className="bg-white dark:bg-gray-800 rounded-lg p-3 sm:p-4 border border-gray-200 dark:border-gray-700" 
            aria-hidden="true"
        ...
        >
          {Array.from({ length: 6 }).map((_, index) => (
            <motion.div
              key={index}
              className="bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 p-4 sm:p-6 h-full flex flex-col animate-pulse"
              aria-hidden="true"
              variants={itemVariants}
              whileHover={{ y: -8 }}
              transition={{ duration: 0.2 }}
            >
              ...
              <div className="flex items-start justify-between mb-3 sm:mb-4 flex-shrink-0">
                <div className="w-3/4 h-5 sm:h-6 bg-gray-200 dark:bg-gray-700 rounded" />
                <div className="w-7 h-7 sm:w-8 sm:h-8 bg-gray-200 dark:bg-gray-700 rounded" />
              </div>
              
              {/* Description */}
              <div className="space-y-2 mb-4 flex-grow">
                <div className="w-full h-3 sm:h-4 bg-gray-200 dark:bg-gray-700 rounded" />
                <div className="w-2/3 h-3 sm:h-4 bg-gray-200 dark:bg-gray-700 rounded" />
              </div>
              ...
              <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between text-xs sm:text-sm space-y-2 sm:space-y-0 mb-4 flex-shrink-0">
                <div className="flex items-center space-x-4">
                  <div className="flex items-center space-x-1">
                    <div className="w-3 h-3 sm:w-4 sm:h-4 bg-gray-200 dark:bg-gray-700 rounded" />
              ...
              <div className="flex flex-col sm:flex-row gap-2 flex-shrink-0">
                <div className="flex-1 h-8 sm:h-9 bg-gray-200 dark:bg-gray-700 rounded" />
                <div className="flex-1 h-8 sm:h-9 bg-gray-200 dark:bg-gray-700 rounded" />
              </div>
            </motion.div>
          ))}
        ...
        >
          <motion.div 
            className="w-full sm:w-auto h-10 sm:h-12 bg-gray-200 dark:bg-gray-700 rounded animate-pulse"
