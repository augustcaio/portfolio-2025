...
function ProjectsList() {
  ...
  const languages = [
    ...new Set(filteredProjects.map((p) => p.language).filter(Boolean)),
  ];
      ...
      <Layout>
        ...
        >
          ...
          >
            ...
            <motion.p 
              className="text-lg sm:text-xl text-gray-600 dark:text-gray-300 max-w-2xl mx-auto px-4"
              initial={{ opacity: 0, y: 20 }}
              animate={{ opacity: 1, y: 0 }}
              transition={{ delay: 0.4, duration: 0.5 }}
            >
              Confira alguns dos projetos que desenvolvi. Cada projeto
              representa uma jornada de aprendizado e inovação.
            </motion.p>
          </motion.header>
